...
const translations: Record<Exclude<AppLocale, 'pt-BR'>, Record<string, string>> = {
  en: {
    'Controles do modo Ultra': 'Ultra mode controls',
    'Conta anterior': 'Previous account',
    'Focar uma': 'Focus one',
    'Próxima conta': 'Next account',
    'Ultra': 'Ultra',
    'Ver grade': 'View grid',
    'Voltar ao AltGrid': 'Back to AltGrid',
    'Sair do Ultra ou da tela cheia': 'Exit Ultra or full screen',
    'Tela cheia e modo Ultra para focar nos jogos': 'Full screen and Ultra mode to focus on games',
    'Limpar RAM': 'Clean RAM',
    'Diagnóstico': 'Diagnostics',
    'Salvar relatório': 'Save report',
    'Diagnóstico local': 'Local diagnostics',
    'RAM total do app': 'Total app RAM',
    'Processo gráfico': 'Graphics process',
    'CPU total do app': 'Total app CPU',
    'Pico de RAM observado': 'Observed RAM peak',
    'Solicitar limpeza escalonada, sem desconectar contas': 'Request staggered cleanup without disconnecting accounts',
    'O relatório não inclui logins, cookies ou credenciais.': 'The report does not include logins, cookies or credentials.',
    'Inativas': 'Inactive',
  ...
  es: {
    'Controles do modo Ultra': 'Controles del modo Ultra',
    'Conta anterior': 'Cuenta anterior',
    'Focar uma': 'Enfocar una',
    'Próxima conta': 'Cuenta siguiente',
    'Ultra': 'Ultra',
    'Ver grade': 'Ver cuadrícula',
    'Voltar ao AltGrid': 'Volver a AltGrid',
    'Sair do Ultra ou da tela cheia': 'Salir del modo Ultra o de pantalla completa',
    'Tela cheia e modo Ultra para focar nos jogos': 'Pantalla completa y modo Ultra para centrarse en los juegos',
    'Limpar RAM': 'Limpiar RAM',
    'Diagnóstico': 'Diagnóstico',
    'Salvar relatório': 'Guardar informe',
    'Diagnóstico local': 'Diagnóstico local',
    'RAM total do app': 'RAM total de la aplicación',
    'Processo gráfico': 'Proceso gráfico',
    'CPU total do app': 'CPU total de la aplicación',
    'Pico de RAM observado': 'Pico de RAM observado',
    'Solicitar limpeza escalonada, sem desconectar contas': 'Solicitar limpieza escalonada sin desconectar cuentas',
    'O relatório não inclui logins, cookies ou credenciais.': 'El informe no incluye inicios de sesión, cookies ni credenciales.',
    'Inativas': 'Inactivas',
