(function () {
  ...
  const translations = {
    en: {
      ...
      'Baixar AltGrid 1.6': 'Download AltGrid 1.6', 'Versão 1.6.6 · Windows': 'Version 1.6.6 · Windows',
      'Explorar jogos idle': 'Explore idle games', 'Catálogo oficial AltGrid': 'Official AltGrid catalog',
      'Outras plataformas do AltGrid': 'AltGrid on other platforms', 'APK 1.6.6': 'APK 1.6.6', 'Escolher versão': 'Choose version',
      ...
      'AltGrid 1.6.6 · Atualização': 'AltGrid 1.6.6 · Update', 'Mais estabilidade para suas sessões.': 'More stability for your sessions.',
      'Esta versão reúne correções de desempenho e memória, melhorias no chat e ajustes de confiabilidade para Android e Linux.': 'This release brings performance and memory fixes, chat improvements, and reliability updates for Android and Linux.',
      'Menos sobrecarga em várias contas.': 'Lower overhead with multiple accounts.', 'Ajustes no gerenciamento de sessões e no modo Eco para reduzir trabalho desnecessário quando há várias contas abertas.': 'Session management and Eco Mode adjustments reduce unnecessary work when several accounts are open.',
      'Contas inativas e fixadas.': 'Inactive and pinned accounts.', 'Encontre sessões encerradas na área de inativas e fixe as abas que deseja manter visíveis.': 'Find closed sessions in Inactive and pin the tabs you want to keep visible.',
      'Respostas e avisos sonoros.': 'Replies and sound alerts.', 'Responda a mensagens e receba avisos sonoros para mensagens diretas e menções.': 'Reply to messages and hear sound alerts for direct messages and mentions.',
      'Correções para Android e Linux.': 'Android and Linux fixes.', 'Melhorias no carregamento dos assets do Hunter Idle no Android e ajustes de empacotamento e inicialização para Linux.': 'Improved Hunter Idle asset loading on Android, plus Linux packaging and startup fixes.',
      ...
      'Atualização integrada': 'Built-in updates', 'Baixar para Windows': 'Download for Windows', 'AltGrid 1.6.6 · Windows 10/11': 'AltGrid 1.6.6 · Windows 10/11',
  ...
  translations.es = Object.assign({}, translations.en, {
    ...
    'Baixar AltGrid 1.6': 'Descargar AltGrid 1.6', 'Versão 1.6.6 · Windows': 'Versión 1.6.6 · Windows', 'APK 1.6.6': 'APK 1.6.6', 'Explorar jogos idle': 'Explorar juegos idle', 'Catálogo oficial AltGrid': 'Catálogo oficial de AltGrid', 'Escolher versão': 'Elegir versión', 'Mais plataformas. Mais controle.': 'Más plataformas. Más control.',
    ...
    'AltGrid 1.6.6 · Atualização': 'AltGrid 1.6.6 · Actualización', 'Mais estabilidade para suas sessões.': 'Más estabilidad para tus sesiones.',
    'Esta versão reúne correções de desempenho e memória, melhorias no chat e ajustes de confiabilidade para Android e Linux.': 'Esta versión reúne mejoras de rendimiento y memoria, mejoras del chat y ajustes de fiabilidad para Android y Linux.',
    'Menos sobrecarga em várias contas.': 'Menos carga con varias cuentas.', 'Ajustes no gerenciamento de sessões e no modo Eco para reduzir trabalho desnecessário quando há várias contas abertas.': 'Los ajustes en la gestión de sesiones y el modo Eco reducen el trabajo innecesario cuando hay varias cuentas abiertas.',
    'Contas inativas e fixadas.': 'Cuentas inactivas y fijadas.', 'Encontre sessões encerradas na área de inativas e fixe as abas que deseja manter visíveis.': 'Encuentra sesiones cerradas en Inactivas y fija las pestañas que quieras mantener visibles.',
    'Respostas e avisos sonoros.': 'Respuestas y alertas de sonido.', 'Responda a mensagens e receba avisos sonoros para mensagens diretas e menções.': 'Responde mensajes y recibe alertas de sonido para mensajes directos y menciones.',
    'Correções para Android e Linux.': 'Correcciones para Android y Linux.', 'Melhorias no carregamento dos assets do Hunter Idle no Android e ajustes de empacotamento e inicialização para Linux.': 'Mejoras en la carga de recursos de Hunter Idle en Android y ajustes de empaquetado e inicio en Linux.',
    ...
    'Pronto para organizar seu grid?': '¿Listo para organizar tu cuadrícula?', 'Baixe o AltGrid 1.6.': 'Descarga AltGrid 1.6.', 'Escolha sua plataforma. As contas, configurações e preferências locais continuam preservadas nas próximas versões.': 'Elige tu plataforma. Las cuentas, configuraciones y preferencias locales se conservarán en futuras versiones.', 'Atualização integrada': 'Actualización integrada', 'Baixar para Windows': 'Descargar para Windows', 'AltGrid 1.6.6 · Windows 10/11': 'AltGrid 1.6.6 · Windows 10/11',
