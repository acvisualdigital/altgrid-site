(function () {
  ...
  const translations = {
    en: {
      ...
      'Baixar AltGrid 1.7': 'Download AltGrid 1.7', 'Versão 1.7.5 · Windows': 'Version 1.7.5 · Windows', 'APK 1.7.5': 'APK 1.7.5',
      'Destaques da versão 1.7': 'Version 1.7 highlights', 'Desempenho máximo. Menos distrações.': 'Maximum performance. Fewer distractions.',
      'AltGrid 1.7.5 · Atualização': 'AltGrid 1.7.5 · Update', 'Foco total em desempenho.': 'Total focus on performance.',
      ...
      'Modo Ultra': 'Ultra mode', 'Baixe o AltGrid 1.7.': 'Download AltGrid 1.7.', 'AltGrid 1.7.5 · Windows 10/11': 'AltGrid 1.7.5 · Windows 10/11',
      ...
      'Entrar': 'Sign in', 'Baixar 1.7': 'Download 1.7', 'Idioma do site': 'Site language', 'Idioma': 'Language',
      'AltGrid, início': 'AltGrid, home', 'Pessoas que já visitaram o AltGrid': 'People who have visited AltGrid',
      'AltGrid 1.7 disponível para Windows, macOS, Linux e Android': 'AltGrid 1.7 available for Windows, macOS, Linux and Android',
      ...
      'Baixar AltGrid 1.7': 'Download AltGrid 1.7', 'Versão 1.7.5 · Windows': 'Version 1.7.5 · Windows',
      'Explorar jogos idle': 'Explore idle games', 'Catálogo oficial AltGrid': 'Official AltGrid catalog',
      'Outras plataformas do AltGrid': 'AltGrid on other platforms', 'APK 1.7.5': 'APK 1.7.5', 'Escolher versão': 'Choose version',
      'Baixar AltGrid pela Microsoft Store': 'Download AltGrid from Microsoft Store', 'AppImage e DEB': 'AppImage and DEB',
      'Destaques da versão 1.7': 'Version 1.7 highlights', 'jogos no app': 'games in the app', 'plataformas': 'platforms', 'contas no Founder': 'accounts on Founder',
      'AltGrid 1.7.5 · Atualização': 'AltGrid 1.7.5 · Update', 'Mais leve em sessões longas.': 'Lighter during long sessions.',
      ...
      'Novidades da versão 1.7': 'What’s new in version 1.7', 'Uma atualização feita para rodar em qualquer tela.': 'An update made to run on any screen.',
      ...
      'Pronto para organizar seu grid?': 'Ready to organize your grid?', 'Baixe o AltGrid 1.7.': 'Download AltGrid 1.7.',
      ...
      'Atualização integrada': 'Built-in updates', 'Baixar para Windows': 'Download for Windows', 'AltGrid 1.7.5 · Windows 10/11': 'AltGrid 1.7.5 · Windows 10/11',
  ...
  translations.es = Object.assign({}, translations.en, {
    ...
    'Baixar AltGrid 1.7': 'Descargar AltGrid 1.7', 'Versão 1.7.5 · Windows': 'Versión 1.7.5 · Windows', 'APK 1.7.5': 'APK 1.7.5',
    ...
    'AltGrid 1.7.5 · Atualização': 'AltGrid 1.7.5 · Actualización', 'Foco total em desempenho.': 'Enfoque total en el rendimiento.',
    ...
    'Modo Ultra': 'Modo Ultra', 'Baixe o AltGrid 1.7.': 'Descarga AltGrid 1.7.', 'AltGrid 1.7.5 · Windows 10/11': 'AltGrid 1.7.5 · Windows 10/11',
    'Ir para o conteúdo': 'Ir al contenido', 'Abrir menu': 'Abrir menú', 'Navegação principal': 'Navegación principal', 'Novidades': 'Novedades', 'Recursos': 'Funciones', 'Jogos idle': 'Juegos idle', 'Planos': 'Planes', 'visitantes': 'visitantes', 'Entrar': 'Entrar', 'Baixar 1.7': 'Descargar 1.7', 'Idioma do site': 'Idioma del sitio', 'Idioma': 'Idioma',
    'AltGrid 1.7 disponível para Windows, macOS, Linux e Android': 'AltGrid 1.7 disponible para Windows, macOS, Linux y Android', 'Seu universo idle.': 'Tu universo idle.', 'Sob controle.': 'Bajo control.',
    ...
    'Baixar AltGrid 1.7': 'Descargar AltGrid 1.7', 'Versão 1.7.5 · Windows': 'Versión 1.7.5 · Windows', 'APK 1.7.5': 'APK 1.7.5', 'Explorar jogos idle': 'Explorar juegos idle', 'Catálogo oficial AltGrid': 'Catálogo oficial de AltGrid', 'Escolher versão': 'Elegir versión', 'Mais plataformas. Mais controle.': 'Más plataformas. Más control.',
    ...
    'AltGrid 1.7.5 · Atualização': 'AltGrid 1.7.5 · Actualización', 'Mais leve em sessões longas.': 'Más ligero durante sesiones largas.',
    ...
    'Novidades da versão 1.7': 'Novedades de la versión 1.7', 'Uma atualização feita para rodar em qualquer tela.': 'Una actualización creada para funcionar en cualquier pantalla.',
    ...
    'Pronto para organizar seu grid?': '¿Listo para organizar tu cuadrícula?', 'Baixe o AltGrid 1.7.': 'Descarga AltGrid 1.7.', 'Escolha sua plataforma. As contas, configurações e preferências locais continuam preservadas nas próximas versões.': 'Elige tu plataforma. Las cuentas, configuraciones y preferencias locales se conservarán en futuras versiones.', 'Atualização integrada': 'Actualización integrada', 'Baixar para Windows': 'Descargar para Windows', 'AltGrid 1.7.5 · Windows 10/11': 'AltGrid 1.7.5 · Windows 10/11',
  ...
  const apply = (language) => {
    ...
    const metadata = {
      pt: ['AltGrid 1.7 — Central multissessão para jogos idle', 'AltGrid 1.7 é a central multiplataforma para organizar múltiplas contas de jogos idle no Windows, macOS, Linux e Android.'],
      en: ['AltGrid 1.7 — Multi-session hub for idle games', 'AltGrid 1.7 is the multiplatform hub for organizing idle game accounts on Windows, macOS, Linux and Android.'],
      es: ['AltGrid 1.7 — Centro multisesión para juegos idle', 'AltGrid 1.7 es el centro multiplataforma para organizar cuentas de juegos idle en Windows, macOS, Linux y Android.']
    }[language]
