(function () {
  ...
  const translations = {
    en: {
      ...
      'Baixar AltGrid 1.6': 'Download AltGrid 1.6', 'Versão 1.6.7 · Windows': 'Version 1.6.7 · Windows',
      'Explorar jogos idle': 'Explore idle games', 'Catálogo oficial AltGrid': 'Official AltGrid catalog',
      'Outras plataformas do AltGrid': 'AltGrid on other platforms', 'APK 1.6.7': 'APK 1.6.7', 'Escolher versão': 'Choose version',
      ...
      'AltGrid 1.6.7 · Atualização': 'AltGrid 1.6.7 · Update', 'Mais estabilidade para sua conta.': 'More stability for your account.',
      'Esta versão corrige a configuração indevida de nick e melhora a confiabilidade da área de contas inativas.': 'This release prevents incorrect nickname setup and improves the reliability of the inactive accounts area.',
      'PERFIL': 'PROFILE', 'Sua conta permanece reconhecida.': 'Your account remains recognized.', 'Uma falha temporária de conexão não abre mais a configuração de nick para perfis já existentes.': 'A temporary connection failure no longer opens nickname setup for existing profiles.',
      'CONTAS': 'ACCOUNTS', 'Área de inativas mais segura.': 'Safer inactive accounts area.', 'Fechamento de sessões protegido contra ações repetidas e conflitos de layout.': 'Session closing is protected against repeated actions and layout conflicts.',
      'INTERFACE': 'INTERFACE', 'Painel de inativas renovado.': 'Redesigned inactive accounts panel.', 'Novo botão de fechar, lista mais clara e navegação aprimorada.': 'A new close button, clearer list and improved navigation.',
      'Atualização multiplataforma.': 'Cross-platform update.', 'Validações para Windows, Microsoft Store, Android, macOS e Linux.': 'Validation for Windows, Microsoft Store, Android, macOS and Linux.',
      ...
      'Atualização integrada': 'Built-in updates', 'Baixar para Windows': 'Download for Windows', 'AltGrid 1.6.7 · Windows 10/11': 'AltGrid 1.6.7 · Windows 10/11',
  ...
  translations.es = Object.assign({}, translations.en, {
    ...
    'Baixar AltGrid 1.6': 'Descargar AltGrid 1.6', 'Versão 1.6.7 · Windows': 'Versión 1.6.7 · Windows', 'APK 1.6.7': 'APK 1.6.7', 'Explorar jogos idle': 'Explorar juegos idle', 'Catálogo oficial AltGrid': 'Catálogo oficial de AltGrid', 'Escolher versão': 'Elegir versión', 'Mais plataformas. Mais controle.': 'Más plataformas. Más control.',
    ...
    'AltGrid 1.6.7 · Atualização': 'AltGrid 1.6.7 · Actualización', 'Mais estabilidade para sua conta.': 'Más estabilidad para tu cuenta.',
    'Esta versão corrige a configuração indevida de nick e melhora a confiabilidade da área de contas inativas.': 'Esta versión evita la configuración incorrecta del nick y mejora la fiabilidad del área de cuentas inactivas.',
    'PERFIL': 'PERFIL', 'Sua conta permanece reconhecida.': 'Tu cuenta permanece reconocida.', 'Uma falha temporária de conexão não abre mais a configuração de nick para perfis já existentes.': 'Un fallo temporal de conexión ya no abre la configuración del nick para perfiles existentes.',
    'CONTAS': 'CUENTAS', 'Área de inativas mais segura.': 'Área de cuentas inactivas más segura.', 'Fechamento de sessões protegido contra ações repetidas e conflitos de layout.': 'El cierre de sesiones está protegido contra acciones repetidas y conflictos de diseño.',
    'INTERFACE': 'INTERFAZ', 'Painel de inativas renovado.': 'Panel de cuentas inactivas renovado.', 'Novo botão de fechar, lista mais clara e navegação aprimorada.': 'Nuevo botón para cerrar, lista más clara y navegación mejorada.',
    'Atualização multiplataforma.': 'Actualización multiplataforma.', 'Validações para Windows, Microsoft Store, Android, macOS e Linux.': 'Validaciones para Windows, Microsoft Store, Android, macOS y Linux.',
    ...
    'Pronto para organizar seu grid?': '¿Listo para organizar tu cuadrícula?', 'Baixe o AltGrid 1.6.': 'Descarga AltGrid 1.6.', 'Escolha sua plataforma. As contas, configurações e preferências locais continuam preservadas nas próximas versões.': 'Elige tu plataforma. Las cuentas, configuraciones y preferencias locales se conservarán en futuras versiones.', 'Atualização integrada': 'Actualización integrada', 'Baixar para Windows': 'Descargar para Windows', 'AltGrid 1.6.7 · Windows 10/11': 'AltGrid 1.6.7 · Windows 10/11',
