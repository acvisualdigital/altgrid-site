(function () {
  ...
  const translations = {
    en: {
      ...
      'Baixar AltGrid 1.7': 'Download AltGrid 1.7', 'Versão 1.7.0 · Windows': 'Version 1.7.0 · Windows',
      'Explorar jogos idle': 'Explore idle games', 'Catálogo oficial AltGrid': 'Official AltGrid catalog',
      'Outras plataformas do AltGrid': 'AltGrid on other platforms', 'APK 1.7.0': 'APK 1.7.0', 'Escolher versão': 'Choose version',
      ...
      'AltGrid 1.7.0 · Atualização': 'AltGrid 1.7.0 · Update', 'Mais leve em sessões longas.': 'Lighter during long sessions.',
      ...
      'Atualização integrada': 'Built-in updates', 'Baixar para Windows': 'Download for Windows', 'AltGrid 1.7.0 · Windows 10/11': 'AltGrid 1.7.0 · Windows 10/11',
  ...
  translations.es = Object.assign({}, translations.en, {
    ...
    'Baixar AltGrid 1.7': 'Descargar AltGrid 1.7', 'Versão 1.7.0 · Windows': 'Versión 1.7.0 · Windows', 'APK 1.7.0': 'APK 1.7.0', 'Explorar jogos idle': 'Explorar juegos idle', 'Catálogo oficial AltGrid': 'Catálogo oficial de AltGrid', 'Escolher versão': 'Elegir versión', 'Mais plataformas. Mais controle.': 'Más plataformas. Más control.',
    ...
    'AltGrid 1.7.0 · Atualização': 'AltGrid 1.7.0 · Actualización', 'Mais leve em sessões longas.': 'Más ligero durante sesiones largas.',
    ...
    'Pronto para organizar seu grid?': '¿Listo para organizar tu cuadrícula?', 'Baixe o AltGrid 1.7.': 'Descarga AltGrid 1.7.', 'Escolha sua plataforma. As contas, configurações e preferências locais continuam preservadas nas próximas versões.': 'Elige tu plataforma. Las cuentas, configuraciones y preferencias locales se conservarán en futuras versiones.', 'Atualização integrada': 'Actualización integrada', 'Baixar para Windows': 'Descargar para Windows', 'AltGrid 1.7.0 · Windows 10/11': 'AltGrid 1.7.0 · Windows 10/11',
