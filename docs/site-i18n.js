(function () {
  ...
  const translations = {
    en: {
      ...
      'Baixar AltGrid 1.6': 'Download AltGrid 1.6', 'Versão 1.6.0 · Windows': 'Version 1.6.0 · Windows',
      'Explorar jogos idle': 'Explore idle games', 'Catálogo oficial AltGrid': 'Official AltGrid catalog',
      'Outras plataformas do AltGrid': 'AltGrid on other platforms', 'APK 1.6.0': 'APK 1.6.0', 'Escolher versão': 'Choose version',
      ...
      'PLATAFORMAS': 'PLATFORMS', 'Windows, Mac, Linux e Android.': 'Windows, Mac, Linux and Android.',
      ...
      'Atualização integrada': 'Built-in updates', 'Baixar para Windows': 'Download for Windows', 'AltGrid 1.6.0 · Windows 10/11': 'AltGrid 1.6.0 · Windows 10/11',
  ...
  translations.es = Object.assign({}, translations.en, {
    ...
    'Baixar AltGrid 1.6': 'Descargar AltGrid 1.6', 'Explorar jogos idle': 'Explorar juegos idle', 'Catálogo oficial AltGrid': 'Catálogo oficial de AltGrid', 'Escolher versão': 'Elegir versión', 'Mais plataformas. Mais controle.': 'Más plataformas. Más control.',
    ...
    'Pronto para organizar seu grid?': '¿Listo para organizar tu cuadrícula?', 'Baixe o AltGrid 1.6.': 'Descarga AltGrid 1.6.', 'Escolha sua plataforma. As contas, configurações e preferências locais continuam preservadas nas próximas versões.': 'Elige tu plataforma. Las cuentas, configuraciones y preferencias locales se conservarán en futuras versiones.', 'Atualização integrada': 'Actualización integrada', 'Baixar para Windows': 'Descargar para Windows',
